...
/*******************************************************/
	...
	#define TSCH_CONF_MAX_EB_PERIOD 5*CLOCK_SECOND //50
	...
	/*******************************************************/
		...
		* contention, energy, latency. */
		...
		#define ORCHESTRA_CONF_EBSF_PERIOD 41 //41.Level TSCH. Default: 397
		...
		#define TSCH_SCHEDULE_CONF_MAX_LINKS 13
...
/*******************************************************/
	...
	/* Antonio lo tiene así en TSCHOrch-STORING*/
	...
	#define RPL_CONF_DIO_INTERVAL_MIN 10		//2¹⁰ms = 1024ms
	...
	#define RPL_CONF_DIO_INTERVAL_DOUBLINGS 12	//2²²ms = 4.194.304ms
